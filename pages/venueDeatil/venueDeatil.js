...
Page({
  data: {
    ...
    testImg:
      "https://xfcgyy.119.gov.cn/manage/img/obs?token=103945fdadafd4e0b08701f148d1e850&url=fb/2021-08-10/04f9c81a-ddd6-4ac5-991f-25fe37b92ebe.jpg",
  },
  onLoad({ fireBrigadeId }) {
    fireBrigadeId = 4724; //测试
    app.login().then(() =>
      app
        .get("/fireBrigades/getDetails", { fireBrigadeId })
        .then((venueDetail) =>
          this.setData({
            venueDetail,
            imgs:
